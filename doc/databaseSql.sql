...
CREATE TABLE APP.ISMS_DATA_CLASS
(
...
-- auto-generated definition
CREATE TABLE APP.ISMS_DATA_CLASS_FILE
(
...
INSERT INTO APP.ISMS_DATA_CLASS (CLASS_ID, CLASS_TYPE, PARENT_ID, CLASS_NAME, POSITION) VALUES (1, 'EVIDENCE', 0, 'Directory', 0);
INSERT INTO APP.ISMS_DATA_CLASS (CLASS_ID, CLASS_TYPE, PARENT_ID, CLASS_NAME, POSITION) VALUES (2, 'DATA', 0, 'Directory', 0);
INSERT INTO APP.ISMS_DATA_CLASS (CLASS_ID, CLASS_TYPE, PARENT_ID, CLASS_NAME, POSITION) VALUES (3, 'SECURITY', 0, 'Directory', 0);

insert into ISMS_DATA_CLASS_FILE(CLASS_ID,FILE_ID) SELECT 1,EVIDENCE_ID from ISMS_EVIDENCE;

CREATE TABLE APP.ISMS_DATA
(
...
CREATE TABLE APP.ISMS_SECURITY
(
  EVIDENCE_ID BIGINT PRIMARY KEY NOT NULL,
  DESCRIPTION LONG VARCHAR,
  PATH VARCHAR(256),
...
-- auto-generated definition
CREATE TABLE APP.ISMS_NETWORK_EVALUATION
(
...
CREATE TABLE APP.ISMS_VULNERABILITY
(
...
CREATE TABLE APP.ISMS_ROLE
(
    ROLE_ID VARCHAR(64) PRIMARY KEY,
    ROLE_NAME VARCHAR(64)
);

CREATE TABLE APP.ISMS_MENU
(
...
CREATE TABLE APP.ISMS_ROLE_MENU
(
    ROLE_ID VARCHAR(64),
    MENU_ID BIGINT,
...
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (1, '基础信息', '/basic_info', 1);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (2, '标准库', '/standards', 2);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (3, '安全评审', '/evaluations', 3);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (4, '证据库', '/evidences_tree', 4);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (5, '信息分级', '/data_tree', 5);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (6, '安全对标', '/security_tree', 6);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (7, '风险库管理', '/risk_library', 7);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (8, '等保标准', '/network_security', 8);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (9, '漏洞管理', '/vulnerability', 9);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (10, '审计日志', null, 10);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (11, '部门管理', '/dept', 11);
INSERT INTO APP.ISMS_MENU (MENU_ID, MENU_NAME, MENU_URL, POSITION) VALUES (12, '角色管理', '/role', 12);


-- auto-generated definition
CREATE TABLE APP.ISMS_AUDIT_LOG
(
