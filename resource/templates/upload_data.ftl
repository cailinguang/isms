<div title="Upload Data" style="display:none" id="upload-evidence">
    <p id="update-evidence-result"></p>
    <form id="upload-evidence-form" method="POST" action="/api/upload_data" enctype="multipart/form-data">
